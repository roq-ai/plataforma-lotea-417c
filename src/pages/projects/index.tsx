...
function ProjectListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ProjectInterface[]>(
    ...
    () =>
      getProjects({
        relations: ['organization', 'task.count', 'terrain.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('terrain', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>terrain</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
