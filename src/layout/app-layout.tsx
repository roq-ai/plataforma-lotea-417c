...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['project-manager', 'team-member', 'administrator', 'surveyor'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Terrain', path: '/terrains', entity: 'terrain', service: AccessServiceEnum.PROJECT, icon: FiMap },
